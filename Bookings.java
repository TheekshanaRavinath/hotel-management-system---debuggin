...
public class Bookings {
	...
	public Bookings(Guest guest, Room room, Date arrivalDate, int stayLength, int numberOfOccupants,
			CreditCard creditCard) {
	...
	public boolean doTimesConflict(Date requestedArrival, int stayLength) {
		...
		boolean doesConflict = requestedArrival.before(bookedDeparture) && requestedDeparture.after(bookedArrival);
